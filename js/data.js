...
const skillBaseData = {
    ...
    "Meditation": { name: "Meditation", maxXp: 100, heroxp: 39, effect: 2, description: "Happiness" },
    ...
    "Dark Influence": { name: "Dark Influence", maxXp: 100, heroxp: 155, effect: 0.1, description: "All XP" },
    "Evil Control": { name: "Evil Control", maxXp: 100, heroxp: 156, effect: 0.1, description: "Evil Gain" },
    "Intimidation": { name: "Intimidation", maxXp: 100, heroxp: 157, effect: -0.01, description: "Reduced Expenses" },
    "Demon Training": { name: "Demon Training", maxXp: 100, heroxp: 174, effect: 0.1, description: "All XP" },
    "Blood Meditation": { name: "Blood Meditation", maxXp: 100, heroxp: 176, effect: 0.1, description: "Evil Gain" },
    "Demon's Wealth": { name: "Demon's Wealth", maxXp: 100, heroxp: 178, effect: 0.02, description: "Hero Pay" },
    "Dark Knowledge": { name: "Dark Knowledge", maxXp: 100, heroxp: 180, effect: 0.03, description: "Hero XP" },

    "Void Influence": { name: "Void Influence", maxXp: 100, heroxp: 206, effect: 0.028, description: "All XP" },
    ...
    "Yin Yang": { name: "Yin Yang", maxXp: 100, heroxp: 290, effect: 50, description: "Essence + Evil Gain" },
    ...
    "Dark Ruler": { name: "Dark Ruler", maxXp: 100, heroxp: 375, effect: 0.00015, description: "Dark Matter Gain" },
